class Images {
  ...
  /// splash images path
  static const String splashImgPath = 'assets/splash_images/';
  static const String pizzaImg = '${splashImgPath}pizza.png';
  static const String burgerImg = '${splashImgPath}burger.png';
  static const String pizzaDishImg = '${splashImgPath}pizza_dish.png';
  static const String maggieImg = '${splashImgPath}maggie.png';
  static const String rolesImg = '${splashImgPath}roles.png';
  static const String shakeImg = '${splashImgPath}shake.png';
  static const String sodaImg = '${splashImgPath}soda.png';
  static const String restaurant = '${splashImgPath}restaurant.png';
  static const String logoIc = 'assets/logo/logo.svg';

  /// auth icons
  static const String authPath = 'assets/auth_icons/';
  static const String appleIc = '${authPath}apple.svg';
  static const String languageIc = '${authPath}language.svg';
  static const String onboardingBack = '${authPath}onboarding_back.png';
  static const String onboard1 = '${authPath}onboard_1.svg';
  static const String onboard2 = '${authPath}onboard_2.svg';
  static const String onboard3 = '${authPath}onboard_3.svg';
  static const String onboard4 = '${authPath}onboard_4.svg';
  static const String facebookIc = '${authPath}facebook.svg';
  static const String googleIc = '${authPath}google.svg';
  static const String checkMailTitle = '${authPath}check_mail_title.svg';
  static const String otpScreenTitle = '${authPath}otp_screen_title.svg';
  static const String passwordScreenTitle =
      '${authPath}password_screen_title.svg';
  static const String resetPassScreenTitle =
      '${authPath}reset_pass_screen_title.svg';

  /// common icons
  static const String commonIcPath = 'assets/common_icons/';
  static const String arrowBackIc = '${commonIcPath}arrow_back.svg';
  static const String closeEyeIc = '${commonIcPath}close_eye.svg';
  static const String openEyeIc = '${commonIcPath}open_eye.svg';
  static const String searchBarIc = '${commonIcPath}search_ic.svg';
  static const String pencilIc = '${commonIcPath}pencil.svg';
  static const String arrowBottomIc = '${commonIcPath}arrow_bottom.svg';
  static const String likeIc = '${commonIcPath}like_ic.svg';
  static const String likeDarkIc = '${commonIcPath}like_dark_ic.svg';
  static const String deleteIc = '${commonIcPath}delete_ic.svg';
  static const String clockSuffixIc = '${commonIcPath}clock_ic.svg';
  static const String button = '${commonIcPath}button.svg';
  static const String calenderIc = '${commonIcPath}calender_ic.svg';

  /// bottom_bar_icons
  static const String bottomBarIcon = 'assets/bottom_bar_icons/';
  static const String categoryBackIc = '${bottomBarIcon}category_back_ic.svg';
  static const String logoBackIc = '${bottomBarIcon}logo_back_ic.svg';
  static const String homeIc = '${bottomBarIcon}house_ic.svg';
  static const String homeDarkIc = '${bottomBarIcon}home_dark_ic.svg';
  static const String searchIc = '${bottomBarIcon}search_ic.svg';
  static const String cartIc = '${bottomBarIcon}cart_ic.svg';
  static const String cartDarkIc = '${bottomBarIcon}cart_ic.svg';
  static const String menuIc = '${bottomBarIcon}menu_ic.svg';
  static const String menuDarkIc = '${bottomBarIcon}menu_dark_ic.svg';
  static const String locationIc = '${bottomBarIcon}location_ic.svg';
  static const String locationDarkIc = '${bottomBarIcon}location_dark_ic.svg';
  static const String favoriteIc = '${bottomBarIcon}favorite_ic.svg';
  static const String favoriteDarkIc = '${bottomBarIcon}favorite_dark_ic.svg';
  static const String profileIc = '${bottomBarIcon}profile_ic.svg';
  static const String emptyCartSvg = '${bottomBarIcon}empty_cart.svg';
  static const String foodIc = '${bottomBarIcon}food_ic.svg';
  static const String pickupIc = '${bottomBarIcon}pickup_ic.svg';
  static const String slotIc = '${bottomBarIcon}slot_ic.svg';
  static const String orderIc = '${bottomBarIcon}order_ic.svg';
  static const String orderDarkIc = '${bottomBarIcon}order_dark_ic.svg';
  static const String qrInitIc = '${bottomBarIcon}qr_init_ic.svg';

  /// home screen icons
  static const String homeSvgIcon = 'assets/home_screen_icons/';
  static const String deliveryIc = '${homeSvgIcon}delivery.svg';
  static const String nearMeIc = '${homeSvgIcon}near_me.svg';
  static const String ratingsIc = '${homeSvgIcon}ratings.svg';
  static const String homeScreenIc = '${homeSvgIcon}home_screen_ic.png';
  static const String closedIc = '${homeSvgIcon}closed.svg';
  static const String homeBookTableIc = '${homeSvgIcon}home_book_table.png';
  static const String orderFoodImg = '${homeSvgIcon}order_food.png';
  static const String bookSlotImg = '${homeSvgIcon}book_slot.png';
  static const String qrScanImg = '${homeSvgIcon}qr_scan.png';
  static const String recommendedIc = '${homeSvgIcon}recommended.svg';
  static const String deliveryBoyIc = '${homeSvgIcon}delivery_boy.svg';
  static const String locationFillIc = '${homeSvgIcon}location_fill.svg';
  static const String clockIc = '${homeSvgIcon}clock.svg';
  static const String thumbIc = '${homeSvgIcon}thumb.svg';
  static const String zigZag = '${homeSvgIcon}zig_zag.svg';
  static const String promo = '${homeSvgIcon}promo.svg';
  static const String card = '${homeSvgIcon}card.svg';
  static const String walletSvg = '${homeSvgIcon}wallet.svg';
  static const String walletVector = '${homeSvgIcon}wallet_vector.svg';
  static const String cashSvg = '${homeSvgIcon}cash.svg';
  static const String elm = '${homeSvgIcon}elm.svg';
  static const String cashFree = '${homeSvgIcon}cashfree.svg';
  static const String homeAddressIc = '${homeSvgIcon}home_address_ic.svg';
  static const String officeAddressIc = '${homeSvgIcon}office_address_ic.svg';
  static const String otherAddressIc = '${homeSvgIcon}other_address_ic.svg';
  static const String callIc = '${homeSvgIcon}call_ic.svg';
  static const String callLightIc = '${homeSvgIcon}call_light_ic.svg';
  static const String directionIc = '${homeSvgIcon}direction_ic.svg';
  static const String dinnerIc = '${homeSvgIcon}dinner_ic.svg';
  static const String breakfastIc = '${homeSvgIcon}breakfast_ic.svg';
  static const String lunchIc = '${homeSvgIcon}lunch_ic.svg';
  static const String successIc = '${homeSvgIcon}success.png';
  static const String failedIc = '${homeSvgIcon}failed.png';
  static const String helpSupportIc = '${homeSvgIcon}help_support.svg';
  static const String loyaltyIc = '${homeSvgIcon}loyalty.svg';
  static const String bookTable = '${homeSvgIcon}book_table.svg';
  static const String orderFood = '${homeSvgIcon}order_food.svg';
  static const String menuPng = '${homeSvgIcon}menu.png';
}
