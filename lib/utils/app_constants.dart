...
import 'package:scan_sa_user/common/models/language_model.dart';
import 'package:scan_sa_user/utils/app_icons.dart';

class AppConstants {
  static const String appName = 'Scan.sa | مسح';
  ...
  static const String webHostedUrl =
      'https://staging-scansa.reliablesolution.in';
  static const bool useReactWebsite = false;

  // static const String baseUrl = 'https://new.friday.sa';
  static const String baseUrl = 'https://staging-scansa.reliablesolution.in';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(
      imageUrl: AppIcons.english,
      languageName: 'English',
      countryCode: 'US',
      languageCode: 'en',
    ),
    LanguageModel(
      imageUrl: AppIcons.arabic,
      languageName: 'عربي',
      countryCode: 'SA',
      languageCode: 'ar',
    ),
