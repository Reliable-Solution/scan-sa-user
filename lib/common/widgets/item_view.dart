...
import 'package:scan_sa_user/features/home/widgets/web/widgets/store_card_widget.dart';
...
import 'package:scan_sa_user/common/widgets/item_shimmer.dart';
...
class _ItemsViewState extends State<ItemsView> {
  ...
  Widget build(BuildContext context) {
    ...
    "isNull $isNull  length$length = widget.stores${widget.stores} = "
            "widget.isStore ${widget.isStore} = widget.isFoodOrGrocery${widget.isFoodOrGrocery}"
        .print;
    return Column(
      children: [
        !isNull
