...
import 'package:scan_sa_user/features/auth/screens/new_user_setup_screen.dart';
import 'package:scan_sa_user/features/brands/screens/brands_product_screen.dart';
import 'package:scan_sa_user/features/brands/screens/brands_screen.dart';
import 'package:scan_sa_user/features/business/screens/subscription_payment_screen.dart';
import 'package:scan_sa_user/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:scan_sa_user/features/chat/domain/models/order_chat_model.dart';
import 'package:scan_sa_user/features/dashboard/screens/qr_scanner_screen/qr_scanner_screen.dart';
import 'package:scan_sa_user/features/dashboard/screens/selection_screen.dart';
import 'package:scan_sa_user/features/loyalty/screens/loyalty_screen.dart';
import 'package:scan_sa_user/features/profile/domain/models/update_user_model.dart';
import 'package:scan_sa_user/features/refer_and_earn/screens/refer_and_earn_screen.dart';
...
import 'package:scan_sa_user/features/chat/domain/models/conversation_model.dart';
...
import 'package:scan_sa_user/features/store/book_slot_screen/reservation_screens/reservation_screen.dart';
import 'package:scan_sa_user/features/store/domain/models/store_model.dart';
import 'package:scan_sa_user/features/address/screens/add_address_screen.dart';
import 'package:scan_sa_user/features/address/screens/address_screen.dart';
import 'package:scan_sa_user/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:scan_sa_user/features/auth/screens/sign_in_screen.dart';
import 'package:scan_sa_user/features/auth/screens/sign_up_screen.dart';
import 'package:scan_sa_user/features/auth/screens/store_registration_screen.dart';
import 'package:scan_sa_user/features/category/screens/category_screen.dart';
import 'package:scan_sa_user/features/location/screens/map_screen.dart';
import 'package:scan_sa_user/features/store/screens/campaign_screen.dart';
...
import 'package:scan_sa_user/common/widgets/image_viewer_screen.dart';
import 'package:scan_sa_user/common/widgets/not_found.dart';
import 'package:scan_sa_user/features/cart/screens/cart_screen.dart';
import 'package:scan_sa_user/features/category/screens/category_item_screen.dart';
import 'package:scan_sa_user/features/chat/screens/chat_screen.dart';
import 'package:scan_sa_user/features/chat/screens/conversation_screen.dart';
import 'package:scan_sa_user/features/checkout/screens/checkout_screen.dart';
import 'package:scan_sa_user/features/payment/screens/offline_payment_screen.dart';
import 'package:scan_sa_user/features/checkout/screens/order_successful_screen.dart';
import 'package:scan_sa_user/features/payment/screens/payment_screen.dart';
import 'package:scan_sa_user/features/payment/screens/payment_webview_screen.dart';
import 'package:scan_sa_user/features/coupon/screens/coupon_screen.dart';
import 'package:scan_sa_user/features/dashboard/screens/dashboard_screen.dart';
import 'package:scan_sa_user/features/favourite/screens/favourite_screen.dart';
import 'package:scan_sa_user/features/item/screens/item_campaign_screen.dart';
import 'package:scan_sa_user/features/item/screens/item_details_screen.dart';
import 'package:scan_sa_user/features/item/screens/popular_item_screen.dart';
import 'package:scan_sa_user/features/verification/screens/forget_pass_screen.dart';
import 'package:scan_sa_user/features/verification/screens/new_pass_screen.dart';
import 'package:scan_sa_user/features/verification/screens/verification_screen.dart';
import 'package:scan_sa_user/features/html/screens/html_viewer_screen.dart';
// import 'package:scan_sa_user/features/interest/screens/interest_screen.dart';
import 'package:scan_sa_user/features/language/screens/language_screen.dart';
import 'package:scan_sa_user/features/location/screens/access_location_screen.dart';
import 'package:scan_sa_user/features/location/screens/pick_map_screen.dart';
import 'package:scan_sa_user/features/notification/screens/notification_screen.dart';
import 'package:scan_sa_user/features/onboard/screens/onboarding_screen.dart';
import 'package:scan_sa_user/features/order/screens/guest_track_order_screen.dart';
import 'package:scan_sa_user/features/order/screens/order_details_screen.dart';
import 'package:scan_sa_user/features/order/screens/order_screen.dart';
import 'package:scan_sa_user/features/order/screens/order_tracking_screen.dart';
import 'package:scan_sa_user/features/order/screens/refund_request_screen.dart';
import 'package:scan_sa_user/features/profile/screens/profile_screen.dart';
import 'package:scan_sa_user/features/profile/screens/update_profile_screen.dart';
import 'package:scan_sa_user/features/store/screens/all_store_screen.dart';
import 'package:scan_sa_user/features/store/screens/store_item_search_screen.dart';
import 'package:scan_sa_user/features/store/screens/store_screen.dart';
import 'package:scan_sa_user/features/review/screens/review_screen.dart';
import 'package:scan_sa_user/features/search/screens/search_screen.dart';
import 'package:scan_sa_user/features/splash/screens/splash_screen.dart';
import 'package:scan_sa_user/features/support/screens/support_screen.dart';
import 'package:scan_sa_user/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:scan_sa_user/features/wallet/screens/wallet_screen.dart';
...
class RouteHelper {
  ...
  static String getBottomRoute({
    bool fromSplash = false,
    bool fromBookTable = false,
  }) =>
      '$dashboard?from-splash=$fromSplash&fromBookTable=$fromBookTable';
  static String getQrRoute() => qrScreen;
  ...
  static String getSearchRoute({
    String? queryText,
    bool fromBookTable = false,
  }) =>
      '$search?query=${queryText ?? ''}&fromBookTable=$fromBookTable';
  static String getStoreRoute({
    required int? id,
    required String page,
    bool fromBookTable = false,
  }) {
    return '$store?id=$id&page=$page&fromBookTable=$fromBookTable';
  }

  static String getReservationScreen() {
  ...
  static String getCheckoutRoute(
    ...
    bool isFromQr = false,
      ...
      '$checkout?page=$page&store-id=$storeId&fromQr=$isFromQr';
  ...
  static String getCartRoute({bool isFromQr = false}) =>
      '$cart?fromQr=$isFromQr';
    ...
    GetPage(
      ...
      page: () => getRoute(
        DashboardScreen(
          pageIndex: 0,
          fromSplash: Get.parameters['from-splash'] == 'true',
          fromBookTable: Get.parameters['fromBookTable'] == 'true',
        ),
      ),
    ),
    GetPage(
        ...
        return getRoute(
          Get.arguments ??
              StoreScreen(
                ...
                fromQr: Get.parameters['from'] == 'qrScan',
                fromBookTable: Get.parameters['fromBookTable'] == 'true',
              ),
              ...
              (!fromCart
                  ...
                  : CheckoutScreen(
                      ...
                      storeId: Get.parameters['store-id'] != 'null'
                          ...
                          : null,
                      fromQR: Get.parameters['fromQr'] == 'true',
                    )),
        );
      },
    ),
