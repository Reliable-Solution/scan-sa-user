...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
  ...
  void initState() {
    ...
    isPhone = Get.find<SplashController>()
            .configModel!
    ...
    isEmail = Get.find<SplashController>()
            .configModel!
            .centralizeLoginSetup!
                ...
                children: [
                  ...
                  !(isPhone || isEmail)
                      ? Padding(
                          ...
                          child: Column(
                            children: [
                              SvgAssets(Images.passwordScreenTitle),
                              const SizedBox(
  ...
  Future<void> _onPressedForgetPass(String countryCode) async {
    ...
    "isEmail $isEmail == $email==== phoneValid.isValid ${phoneValid.isValid}"
        .print;

    if (_formKeyLogin!.currentState!.validate()) {
      if (!phoneValid.isValid || !isEmail) {
        showCustomSnackBar(
          !phoneValid.isValid ? 'invalid_phone_number'.tr : '',
        );
      } else {
