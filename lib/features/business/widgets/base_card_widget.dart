...
//             color: businessController.businessIndex == index ? context.color.secondary.withValues(alpha: 0.05) : Theme.of(context).cardColor,
//             border: businessController.businessIndex == index && isDesktop ? Border.all(color: context.color.secondary) : !isDesktop ? Border.all(color: businessController.businessIndex == index ? context.color.secondary
...
//               child: Text(title, style: robotoMedium.copyWith(color: businessController.businessIndex == index ? context.color.secondary : Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7), fontSize: Dimensions.fontSizeDefault,
