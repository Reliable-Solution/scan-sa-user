...
import 'package:scan_sa_user/features/auth/widgets/pickup_zone_widget.dart';
import 'package:scan_sa_user/features/auth/widgets/zone_selection_widget.dart';
                  ...
                  children: [
                    ...
                    !widget.fromView
                        ? Positioned(
                            ...
                            right: 20,
                            bottom:
                                ResponsiveHelper.isDesktop(context) ? 40 : 20,
                            child: AppButton(
