...
import 'package:scan_sa_user/features/chat/widgets/chat_serach_field_widget.dart';
...
import 'package:scan_sa_user/features/chat/widgets/web_chat_view_widget.dart';
                    ...
                    children: [
                      ...
                      SizedBox(
                        height: (AuthHelper.isLoggedIn() &&
                                conversation != null &&
                                conversation.conversations != null &&
                                chatController.conversationModel!.conversations!
                                    .isNotEmpty)
                                                                    ...
                                                                    ? Positioned(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            style:
                                                                                robotoMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeExtraSmall),
                                                                          ),
                                                                        ),
                                                                      )
                                                                    : const SizedBox();
