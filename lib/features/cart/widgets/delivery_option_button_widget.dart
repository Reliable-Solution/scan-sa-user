  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 200), () {
      Get.find<CheckoutController>().setOrderType(
        widget.fromQr
            ? 'dine_in'
            : Get.find<SplashController>().configModel!.homeDeliveryStatus ==
                        1 &&
      ...
      builder: (checkoutController) {
        ...
        return InkWell(
          onTap: () {
            ...
            if (checkoutController.isTakeAway || checkoutController.isDineIn) {
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: select ? context.color.secondary : Colors.transparent,
              ),
            ),
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.symmetric(
                        vertical: widget.value == 'dine_in' ? 8 : 0,
                      ),
                      child: Text(
                        widget.title,
