...
import 'package:scan_sa_user/features/cart/widgets/extra_packaging_widget.dart';
import 'package:scan_sa_user/features/cart/widgets/not_available_bottom_sheet_widget.dart';
...
import 'package:scan_sa_user/helper/module_helper.dart';
...
import 'package:scan_sa_user/common/widgets/web_constrained_box.dart';
import 'package:scan_sa_user/common/widgets/web_page_title_widget.dart';
import 'package:scan_sa_user/features/cart/widgets/cart_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:scan_sa_user/features/cart/widgets/web_cart_items_widget.dart';
import 'package:scan_sa_user/features/cart/widgets/web_suggested_item_view_widget.dart';
...
class CartScreen extends StatefulWidget {
  const CartScreen({super.key, required this.fromNav, required this.fromQr});
  final bool fromNav;
  final bool fromQr;
                  ...
                  ? Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            height: splashController.configModel?.moduleConfig
                                        ?.module?.addOn ??
                                    false
                                ? 10
                                : 0,
                          ),
                          splashController.configModel?.moduleConfig?.module
                                      ?.addOn ??
                                  false
                              ? Row(
                                  mainAxisAlignment:
              ...
              return storeController.cartSuggestItemModel != null &&
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height:
                              ResponsiveHelper.isDesktop(context) ? 160 : 130,
...
num _calculateOriginalDeliveryCharge({
  ...
  if (store != null &&
    ...
    perKmCharge =
        store.perKmShippingCharge?.printWithName('store.perKmShippingCharge');
    minimumCharge = store.minimumShippingCharge
        ?.printWithName('store.minimumShippingCharge');
    maximumCharge = store.maximumShippingCharge
        .printWithName('store.maximumShippingCharge');
  } else if (store != null &&
      distance != null &&
      distance != -1 &&
      moduleData != null) {
    perKmCharge = moduleData.perKmShippingCharge
        ?.printWithName('moduleData.perKmShippingCharge');
    minimumCharge = moduleData.minimumShippingCharge
        ?.printWithName('moduleData.minimumShippingCharge');
    maximumCharge = moduleData.maximumShippingCharge
        .printWithName('moduleData.maximumShippingCharge');
  }
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    //   style: robotoMedium.copyWith(color: ResponsiveHelper.isDesktop(context) ? Theme.of(context).textTheme.bodyLarge?.color : context.color.secondary), textDirection: TextDirection.ltr,
                    // ),
                  ],
                ),
              ),
