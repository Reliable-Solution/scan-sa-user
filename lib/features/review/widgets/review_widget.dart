...
import 'package:scan_sa_user/common/widgets/readmore_widget.dart';
      ...
      children: [
        ...
        isDesktop
            ...
            : ReadMoreText(
                ...
                trimLines: 3,
                colorClickableText: context.color.secondary,
                lessStyle: robotoBold.copyWith(color: context.color.secondary),
                trimCollapsedText: 'show_more'.tr,
                trimExpandedText: ' ${'show_less'.tr}',
                moreStyle: robotoBold.copyWith(color: context.color.secondary),
              ),
