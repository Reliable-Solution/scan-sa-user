...
import 'package:scan_sa_user/features/location/widgets/dynamic_text_color.dart';
...
import 'package:scan_sa_user/features/location/domain/models/prediction_model.dart';
...
import 'package:scan_sa_user/features/location/widgets/web_landing_page_shimmer_widget.dart';
...
import 'package:scan_sa_user/common/widgets/custom_loader.dart';
...
import 'package:scan_sa_user/features/location/widgets/landing_card_widget.dart';
import 'package:scan_sa_user/features/location/widgets/registration_card_widget.dart';
                      ...
                      children: [
                        ...
                        SizedBox(
                          height: (splashController
                                          .landingModel?.availableZoneStatus ==
                                      1 &&
                                  splashController.landingModel!
                                      .availableZoneList!.isNotEmpty)
                              ? 40
                        ...
                        SizedBox(
                          height:
                              AppConstants.whyChooseUsList.isNotEmpty ? 40 : 0,
                        ),
              ...
              Expanded(
                child: LandingCardWidget(
                  ...
                  title: splashController
                          .landingModel!.specialCriterias![index].title ??
                      '',
                ),
              ),
              SizedBox(
                width: index !=
                        splashController
                                .landingModel!.specialCriterias!.length -
                            1
                    ? 30
                    : 0,
              ),
