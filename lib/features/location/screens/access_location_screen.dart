...
import 'package:scan_sa_user/common/widgets/no_internet_screen.dart';
...
import 'package:scan_sa_user/features/location/screens/web_landing_page.dart';
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Icon(Icons.map, color: context.color.secondary),
                  ),
                  Text(
                    'set_from_map'.tr,
                    textAlign: TextAlign.center,
