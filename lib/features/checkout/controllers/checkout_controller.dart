...
import 'package:scan_sa_user/features/checkout/domain/models/timeslote_model.dart';
import 'package:scan_sa_user/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:scan_sa_user/features/checkout/widgets/order_successfull_dialog.dart';
import 'package:scan_sa_user/features/checkout/widgets/partial_pay_dialog_widget.dart';
    ...
    if (isSuccess) {
      ...
      if (paymentMethodIndex == 2) {
        if (GetPlatform.isWeb) {
          ...
          "===>> here check out flow is here 1".print;
          Get.offNamed(
        ...
        if (ResponsiveHelper.isDesktop(Get.context) &&
          ...
          Get.offNamed(RouteHelper.getBottomRoute());
          Future.delayed(
          ...
          "===>> here check out flow is here 2".print;
          Get.offNamed(
