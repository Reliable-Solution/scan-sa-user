...
import 'package:scan_sa_user/features/checkout/widgets/slot_widget.dart';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: ((checkoutController.selectedDateSlot ==
                                              0 &&
                                          widget.todayClosed) ||
                                      (checkoutController.selectedDateSlot ==
                                              1 &&
      ...
      child: Column(
        children: [
          Text(
            title,
            style: isSelected
                ? robotoBold.copyWith(color: context.color.secondary)
                : robotoMedium,
          ),
          ResponsiveHelper.isDesktop(context)
              ? const SizedBox(height: Dimensions.paddingSizeSmall)
