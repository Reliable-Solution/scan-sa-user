...
import 'package:scan_sa_user/features/checkout/widgets/prescription_image_picker_widget.dart';
...
import 'package:scan_sa_user/features/checkout/widgets/condition_check_box.dart';
import 'package:scan_sa_user/features/checkout/widgets/coupon_section.dart';
import 'package:scan_sa_user/features/checkout/widgets/note_prescription_section.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          isDesktop
              ? pricingView(context: context, takeAway: takeAway || isDineIn)
              : const SizedBox(),
