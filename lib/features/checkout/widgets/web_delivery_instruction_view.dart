    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          // boxShadow: [BoxShadow(color: context.color.secondary.withValues(alpha: 0.05), blurRadius: 10)],
          borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
          border: Border.all(
            color: context.color.secondary.withValues(alpha: 0.20),
          ),
        ),
          ...
          builder: (checkoutController) {
            return Column(
              ...
              children: [
                ...
                //           child: Container(
                //             decoration: BoxDecoration(
                //               color: isSelected ? context.color.secondary.withValues(alpha: 0.5) : Colors.grey[200],
                //               borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                ...
                //             child: Row(children: [
                //               Icon(Icons.ac_unit, color: isSelected ? context.color.secondary : Theme.of(context).disabledColor, size: 18),
                //               const SizedBox(width: Dimensions.paddingSizeSmall),
                //
                //               Expanded(
                //                 child: Text(
                //                   AppConstants.deliveryInstructionList[index].tr,
                //                   style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: isSelected ? context.color.secondary : Theme.of(context).disabledColor),
                //                 ),
                //               ),
                //             ]),
                //           ),
                ...
                //         style: robotoRegular.copyWith(color: context.color.secondary),
                //       ),
                //
                //       InkWell(
