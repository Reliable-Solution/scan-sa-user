...
import 'package:scan_sa_user/common/widgets/address_widget.dart';
...
import 'package:scan_sa_user/common/widgets/not_logged_in_screen.dart';
import 'package:scan_sa_user/features/checkout/widgets/checkout_screen_shimmer_view.dart';
import 'package:scan_sa_user/features/checkout/widgets/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:scan_sa_user/features/checkout/widgets/bottom_section.dart';
import 'package:scan_sa_user/features/checkout/widgets/top_section.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> initCall() async {
    ...
    // checkoutController.setGuestAddress(null, isUpdate: false);
    checkoutController.initAdditionData();
    ...
    if (widget.storeId == null) {
      ...
      if (_cartList != null && _cartList!.isNotEmpty) {
        checkoutController.initCheckoutData(_cartList![0]!.item!.storeId);
      }
    }
    if (widget.storeId != null) {
      checkoutController.initCheckoutData(widget.storeId);
    ...
    checkoutController.updateTips(
      checkoutController.getSharedPrefDmTipIndex().isNotEmpty
          ? int.parse(checkoutController.getSharedPrefDmTipIndex())
          : 0,
      notify: false,
    );
  ...
  void _setSinglePaymentActive() {
    if ((!_firstTimeCheckPayment &&
      ...
      Future.delayed(const Duration(milliseconds: 600), () {
        checkoutController.setPaymentMethod(2, isUpdate: false);
              ...
              builder: (checkoutController) {
                ...
                return GetBuilder<CouponController>(
                  builder: (couponController) {
                    ...
                    num additionalCharge = Get.find<SplashController>()
                            .configModel!
                    ...
                    if ((checkoutController.isDelivery) &&
                        checkoutController.store != null) {
                      if (checkoutController.store!.freeDelivery!) {
          ...
          onPressed: checkoutController.acceptTerms
              ? () {
                  ...
                  if (isGuestLogIn &&
                      ...
                      (checkoutController.isTakeAway ||
                          checkoutController.isDineIn)) {
                    showCustomSnackBar(
                  ...
                  } else if ((checkoutController.isTakeAway ||
                          checkoutController.isDineIn) &&
                    ...
                    if (widget.storeId == null) {
                      ...
                      PlaceOrderBodyModel placeOrderBody = PlaceOrderBodyModel(
                        ...
                        chargePayer: null,
                        dmTips: (checkoutController.isTakeAway ||
                                checkoutController.isDineIn ||
                                checkoutController.tipController.text ==
                                    'not_now')
                            ? ''
