...
import 'package:scan_sa_user/features/location/widgets/permission_dialog_widget.dart';
...
import 'package:scan_sa_user/helper/marker_helper.dart';
...
import 'package:scan_sa_user/features/order/widgets/track_details_view_widget.dart';
import 'package:scan_sa_user/features/order/widgets/tracking_stepper_widget.dart';
      ...
      body: GetBuilder<OrderController>(
        builder: (orderController) {
          ...
          return track != null
              ? Builder(
                  builder: (context) {
                    final isTakeAway = track?.orderType == 'take_away';
                    final isDineIn = track?.orderType == 'dine_in';
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: TrackingStepperWidget(
                                    ...
                                    takeAway: isTakeAway || isDineIn,
                                  ),
                                ),
                                Positioned(
                                  right: 15,
                                  bottom: isTakeAway ||
                                          isDineIn && track.deliveryMan == null
                                      ? 150
                                      : 220,
                                  child: InkWell(
