...
import 'package:scan_sa_user/common/widgets/card_design/store_card_with_distance.dart';
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            style:
                                                                                robotoBold.copyWith(color: context.color.secondary, fontSize: Dimensions.fontSizeOverSmall),
                                                                          ),
                                                                          const SizedBox(
                                                                            width:
                                                                                Dimensions.paddingSizeExtraSmall,
                                                                          ...
                                                                          Text(
                                                                            'from_you'.tr,
                                                                            style:
                                                                                robotoRegular.copyWith(color: context.color.secondary, fontSize: Dimensions.fontSizeOverSmall),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                    ),
