...
import 'package:scan_sa_user/features/home/widgets/web/widgets/arrow_icon_button.dart';
...
import 'package:scan_sa_user/common/widgets/add_favourite_view.dart';
import 'package:scan_sa_user/common/widgets/card_design/store_card.dart';
import 'package:scan_sa_user/common/widgets/custom_image.dart';
import 'package:scan_sa_user/common/widgets/discount_tag.dart';
import 'package:scan_sa_user/common/widgets/hover/on_hover.dart';
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            border: isPharmacy
                                                                                ? null
                                                                                : Border.all(color: context.color.secondary.withValues(alpha: 0.2), width: 2),
                                                                          ),
                                                                          child:
                                                                              Stack(
                                                                            children: [
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  Icon(Icons.star, size: 15, color: context.color.secondary),
                                                                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                child: Row(
                                                                                  children: [
                                                                                    ...
                                                                                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                                    Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'km'.tr}', style: robotoBold.copyWith(color: context.color.secondary, fontSize: Dimensions.fontSizeExtraSmall)),
                                                                                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                                    Text('from_you'.tr, style: robotoRegular.copyWith(color: context.color.secondary, fontSize: Dimensions.fontSizeExtraSmall)),
                                                                                  ],
                                                                                ),
                                                                              ),
                                                                            ],
