...
class SearchService implements SearchServiceInterface {
  ...
  @override
  Future<dynamic> getSearchData(String? query, bool isStore) async {
    return searchRepositoryInterface.getList(query: query, isStore: isStore);
  }

  @override
  Future<dynamic> getSuggestedItems() async {
    return searchRepositoryInterface.getList(isSuggestedItems: true);
  }
  ...
  List<Item>? sortItemSearchList(
    ...
    if (sortIndex != -1) {
      if (sortIndex == 0) {
        ...
        final iterable = searchItemList.reversed;
  ...
  List<Store>? sortStoreSearchList(
    ...
    if (storeSortIndex != -1) {
      if (storeSortIndex == 0) {
        ...
        final iterable = searchStoreList.reversed;
