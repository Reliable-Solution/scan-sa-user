...
//             final List<MethodInformations>? methodInformation =
...
//                                   Image.asset(Images.offlinePayment,
//                                       height: 100),
//                                   const SizedBox(
...
//                                           .offlineMethodList!.length,
//                                       itemBuilder: (context, index) {
//                                         final var selected = paymentController
...
//                                     ),
//                                   ),
//                                   if (ResponsiveHelper.isDesktop(context)) completeButton(
//                                           paymentController, methodInformation) else const SizedBox(),
//                                 ],
//                               ),
//                             ),
//                           ),
//                         ),
//                       ),
//                       if (!ResponsiveHelper.isDesktop(context)) completeButton(paymentController, methodInformation) else const SizedBox(),
//                     ],
//                   )
...
//     for (var i = 0; i < methodInformation!.length; i++) {
...
//                 if (complete) {
//                   final methodId = paymentController
//                       .offlineMethodList![
//                           paymentController.selectedOfflineBankIndex]
//                       .id
//                       .toString();
